...
const playMemeSound = (soundId) => {
  ...
  `${backendUrl}/donations/gettips?channel=${encodeURIComponent(streamerSlug)}`,
  {
    method: "GET",
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-pink-100 overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center px-6">
            ...
            <div className="ml-5 text-white drop-shadow-lg">
              <h2 className="text-xl font-bold leading-tight">Barbie</h2>
              <p className="text-xs opacity-90">@BarbieOwO • 10.4K subscribers</p>
            </div>
